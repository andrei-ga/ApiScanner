...
namespace ApiScanner.DataAccess.Migrations
{
    ...
    [Migration("20180301133218_AddConfiguration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiScanner.Entities.Models.ApiWidgetModel", b =>
                {
                    b.Property<Guid>("ApiId");

                    b.Property<Guid>("WidgetId");

                    b.HasKey("ApiId", "WidgetId");

                    b.HasIndex("WidgetId");

                    b.ToTable("ApiWidgets");
                });
            ...
            modelBuilder.Entity("ApiScanner.Entities.Models.ConfigurationModel", b =>
                {
                    b.Property<string>("Name")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("ApiScanner.Entities.Models.WidgetModel", b =>
                {
                    b.Property<Guid>("WidgetId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ApiScanner.Entities.Models.ApiWidgetModel", b =>
                {
                    ...
                    b.HasOne("ApiScanner.Entities.Models.WidgetModel", "Widget")
                        .WithMany("ApiWidgets")
