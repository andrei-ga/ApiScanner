...
namespace ApiScanner.DataAccess.Repositories
{
    public interface IApiLogRepository
    {
        ...
        /// <returns></returns>
        Task<IEnumerable<ApiLogDTO>> GetApiLogsAsync(Guid id, bool includeContent, bool includeHeaders, DateTime? dateFrom);
        ...
        /// <param name="dateFrom">Date from when to get api logs. Will return all if null.</param>
        /// <returns></returns>
        Task<IEnumerable<ApiLogDTO>> GetApiLogsByWidgetAsync(Guid widgetId, bool includeContent, bool includeHeaders, DateTime? dateFrom);
    }
}
